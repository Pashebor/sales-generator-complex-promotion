                    ...
                    <div className="container">
                        ...
                        <div className="wdyg-info">
                            <div className="wdyg-info__item">
                                ...
                                <p>Увеличиваем количество посетителей Вашего сайта в несколько раз</p>
                            </div>
                            <div className="wdyg-info__item">
                                ...
                                <p>Ваши клиенты будут возвращаться к Вам снова и снова</p>
                            </div>
                            <div className="wdyg-info__item">
                                ...
                                <p>Повышаем конверсионность  сайта, превращая посетителей в клиентов</p>
                            </div>
                            <div className="wdyg-info__item">
                                ...
                                <p>Чем дольше мы с Вами работаем, тем дешевле обходятся Вам клиенты</p>
                            </div>
                        </div>
                    </div>
