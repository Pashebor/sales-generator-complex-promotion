                    ...
                    <div className="container">
                        ...
                        <div className="cl-words-info">
                            ...
                            <div className="cl-words-info__desc">
                                ...
                                <p>Обещанные через 9 месяцев результаты мы получили уже на 5-й месяц. А сейчас, спустя год, могу открыть маленькую тайну: мы выросли в ежемесячных продажах с сайта со 100 000 рублей до 5 000 000 рублей и продолжаем расти.</p>
                            </div>
                        </div>
                    </div>
